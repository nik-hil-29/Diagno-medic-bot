...
headers = {"Authorization": f"Bearer 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"}
nltk.download("punkt")
...
if audio_file:
    ...
    chat = JinaChat(
        temperature=0.2,
        streaming=True,
        jinachat_api_key="W4WamP7aJIcNUrHrUzPj:a97df0178d2b2bc2cd5ebca3ae6850183fc436b7fcd8bdde70d3dd4b7bd32552",
    )
